...
public class EmailSender{
	...
	public static void sendEmail(String toEmail,String userName,String activationCode){
		...
		try{
			...
			String link = "http://localhost:8080/3_send_email/activate_account.do?email="+toEmail+"&activation_code="+activationCode;
