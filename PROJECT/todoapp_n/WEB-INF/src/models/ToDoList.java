...
public class ToDoList{
	...
	public void saveToDo(){
		...
		try{
			...
			con = DriverManager.getConnection("jdbc:mysql://localhots:3306/todoapp?user=root&password=1234");
	...
	public static ArrayList<ToDoList> collectAllToDos(int userId){
		...
		try{
			...
			String query = "select todolist_id,title,created from todolist where user_id=? and status_id=1;";
